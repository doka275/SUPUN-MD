...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'SUPUN-MD=yV8EGQoJ#dSmoJrfbfG4DeNY97sGtXdT0gzh1K7bA5XR7xzzDcvU' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '94716124161' : process.env.OWNER_NUMBER,
MODE: process.env.MODE === undefined ?"public" : process.env.MODE,
AUTO_READ_STATUS: process.env.AUTO_READ_STATUS === undefined ?"false" : process.env.AUTO_READ_STATUS,
AUTO_STATUS_REACT: process.env.AUTO_STATUS_REACT === undefined ?"fale" : process.env.AUTO_STATUS_REACT,
